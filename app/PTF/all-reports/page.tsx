  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2 bangla-text">সকল রিপোর্ট</h2>
          <p className="text-gray-600 bangla-text">প্ল্যাটফর্মে থাকা সকল রিপোর্ট এবং তাদের অবস্থা।</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle className="bangla-text">রিপোর্ট তালিকা ({reports.length}টি)</CardTitle>
